# Getting help with DataScienceNotes

Thanks for using DataScienceNotes. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/DataScienceNotes/issues) to make sure the 
